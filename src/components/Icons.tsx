...
const IconSvgBase = ({ children, width = 24, height = 24, fill = "black", viewbox = "0 -960 960 960" }: IconSvgBaseProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height={`${height}px`} viewBox={viewbox} width={`${width}px`} fill={`${fill}`}>
            {children}
        </svg>
    )
}
...
const IconGithub = ({ fill, width = 24, height = 24, viewbox = "0 0 448 512" }: Omit<IconSvgBaseProps, "children">) => (
...
export { IconDarkMode, IconBackArrow, IconOpenInNew, IconGithub };
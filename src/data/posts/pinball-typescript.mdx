---
title: "Pinball Game"
excerpt: "A typescript pinball game inspired from 80's table game."
...
-	🧲 Realistic Ball Physics: Implemented using [Matter.js] or custom force logic, including friction, gravity, and rebounds.
...
## Next Steps
-	Add levels, multi-ball mode, and more complex bumpers.
...
(Insert animated GIFs, looped gameplay clip, or playable iframe if available)


If you’d like, I can also help write a blog post version, or include technical details like pseudocode, architecture decisions, or dev logs. Would you like to highlight it more from the developer perspective, or keep it a balance with UX/game design?
